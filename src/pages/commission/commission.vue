    ...
    <div class="flex flex-row absolute">
        ...
        <div class=" flex flex-col h-screen">
            ...
            <div class="relative ml-12 gap-4 justify-center mt-14 md:mt-14 items-center font-bold">
                <small class="text-grey mb-4"> you cannot withdraw below 5000</small>
                <form action="">
                    <input required type="number" step="any" placeholder="0" class="w-full mt-2 h-12 pl-2 rounded-2xl border">
